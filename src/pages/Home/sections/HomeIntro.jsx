    ...
    <section className="homeIntro" id="home-intro" ref={ref} aria-label="Company introduction">
      ...
      <div className="homeIntro-container">
        ...
        >
          ...
          >
            <span className="homeIntro-standard" style={{ borderColor: '#C9A22D', color: '#C9A22D' }}>
              British Standards (BS 8666)
            </span>
            <span className="homeIntro-standard" style={{ borderColor: '#243F88', color: '#243F88' }}>
          ...
          >
            ...
            <span className="homeIntro-ctaArrow" aria-hidden="true">→</span>
          </motion.button>
        </motion.div>
      </div>
    </section>
